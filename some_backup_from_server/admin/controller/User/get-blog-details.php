...
$aColumns = array('title', 'description', 'meta_title', 'meta_description', 'meta_keyword');
$sIndexColumn = "id";
$sTable = "articles";
/*
  * Paging
...
while ($aRow = $rResult->fetch_assoc()) {
  ...
  $row = array();
  if ($aRow['media_type'] == 'image') {
    $media = '<a href="' . $base_url . $aRow['media'] . '" target="_blank"><img alt="blog file" src="' . $base_url . $aRow['media'] . '" height="80" width="100"></a>';
  } else {
    $media = '';
  }
  ...
  $row[] = '<div class="dropdown">
    ...
    <div class="dropdown-menu" aria-labelledby="dropdownMenuButton">
      <a class="dropdown-item editBlog" href="javascript:void(0)" data-id="' . $aRow['id'] . '">Edit</a>
      <a class="dropdown-item deleteBlog" href="javascript:void(0)" data-id="' . $aRow['id'] . '">Delete</a>
    </div>
  </div>';
